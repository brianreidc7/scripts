...
  
- If not installed , then install the module using ClickOnce 
- Load the module 
- Load (dotSource) the acociated script 
 
this includes ClickOnce functions to : 
- Install 
- uninstall 
- test 
- locate the installed location 
 
#> 
