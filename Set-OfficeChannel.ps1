...
function Show-Menu
{
     ...
     Write-Host "=============== $Title2 ============="
     Write-host " "
     Write-Host "1: Press '1' for Office Insiders – monthly builds (Insiders)"
     Write-Host "2: Press '2' for Current Channel (Monthly)"
     Write-Host "3: Press '3' for Semi-Annual Channel (Targeted)"
     Write-Host "4: Press '4' for Semi-Annual Channel (Broad)"
     Write-Host "4: Press '5' for Volume Licence Office 2019 (PerpetualVL2019)"
     Write-Host ""
     ...
     switch ($input)
     {
	     '1' {
                ...
                'You chose option #1 - Monthly Channel (Targeted)'
                $Channel = "Insiders"
           } '2' {
                
                'You chose option #2 - Monthly Channel'
                $Channel = "Monthly"
             } '3' {
                
                'You chose option #3 - Semi-Annual Channel (Targeted)'
                $Channel = "Targeted"
             } '4' {
                
                'You chose option #4- for Semi-Annual Channel'
                $Channel = "Broad"
             } '5' {
                
                'You chose option #5- Perpetual Volume Licence Channel (for VL versions of Office 2019 only)'
