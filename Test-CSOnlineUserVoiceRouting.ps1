...
if (!$Connected) {
    ...
    Write-Host "No existing PowerShell Session... ...Connecting"
...
if ($UserReturned) {
    ...
    $NormalisedResult = Test-CsEffectiveTenantDialPlan -DialedNumber $DialedNumber -EffectiveTenantDialPlanName $EffectiveDialPlan.EffectiveTenantDialPlanName
